            ...
            <div class="row" style="margin-top: 20px">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        {{--                        </div>--}}
                        <div class=card-header>
                            <h4 class="card-header-title"><i class="tio-arrow-backward"></i> Single Agent Sale & Commission Report</h4>
                            ...
                            <div class=card-header-form>
                                ...
                                <a href="" class="btn btn-dark">Add Withdrawl Amount</a><button type="button" class="btn btn-warning ml-1"><i class="tio-print"></i> Print</button>
                            </div>
                        </div>
                        <div class="card-body">
