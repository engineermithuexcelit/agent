            ...
            <div class="row" style="margin-top: 20px">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        {{--                        </div>--}}
                        <div class=card-header>
                            <h4 class="card-header-title">Agent Sale & Commission Summary</h4>
                            ...
                            <div class="table-responsive">
                                <table style="text-align: left;"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">Total No. of Agent</th>
                                        <th scope="col">No. of Active Agent</th>
                                        <th scope="col">All Agents Today Sale</th>
                                        <th scope="col">All Agents Today Commission</th>
                                        <th scope="col">All Agent Today Withdraw</th>
                                        <th scope="col">All Agent Remaining Balance</th>
