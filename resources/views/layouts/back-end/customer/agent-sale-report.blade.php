            ...
            <div class="row" style="margin-top: 20px">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        {{--                        </div>--}}
                        <div class=card-header>
                            <h4 class="card-header-title">Agent Sale Report</h4>
                            ...
                            <div class="table-responsive">
                                <table style="text-align: left;"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">This Month Sale Amount</th>
                                        <th scope="col">This Week Sale Amount</th>
                                        <th scope="col">Today Sale</th>
                                        <th scope="col">Total Commission Amount</th>
                                        <th scope="col">Commission Payment</th>
